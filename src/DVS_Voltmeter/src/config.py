...
# elif cfg.SENSOR.CAMERA_TYPE == "Clean":
#     __C.SENSOR.K = [0.00018 * 29250, 0, 1e-18, 0, 0, 0]
...
camera_para = {}
camera_para["DVS346"] = [0.00018 * 29250, 20, 0.0001, 1e-7, 5e-9, 0.00001]
camera_para["DVS240"] = [0.000094 * 47065, 23, 0.0002, 1e-7, 5e-8, 0.00001]
camera_para["Clean"] = [0.00018 * 29250, 0, 1e-18, 0, 0, 0]  # somehow k3 should avoid completely zero
camera_para["CleanBiased"] = [0.00018 * 29250, 20, 1e-18, 0, 0, 0]
